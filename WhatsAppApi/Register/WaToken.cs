...
namespace WhatsAppApi.Register
{
    class WaToken
    {
        ...
        public static string GenerateToken(string number, string buildHash)
        {
            return string.Format(WhatsRegisterV2.WaBuildHashData.Token, number).ToMD5String();
            ...
            //data.AddRange(Convert.FromBase64String(buildHash));
